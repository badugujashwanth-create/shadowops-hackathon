# Contributing to ShadowOps Safety Lab
...
2. Install dependencies with `Backend lite: pip install -r backend-ml/requirements-lite.txt; frontend: npm ci --prefix frontend`.
