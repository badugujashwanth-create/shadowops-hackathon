...
from training.generate_reward_curves import generate_reward_curves  # noqa: E402
...
def write_evaluation_summary() -> dict[str, Any]:
    ...
    summary = {
        ...
        "training_curve_note": "Training curves are generated only from real trainer_state.json or metrics.jsonl artifacts.",
        "rows": rows,
    ...
    lines.extend(["", "### Pending Model Metrics", "", f"- trained checkpoint metrics: {PENDING}"])
